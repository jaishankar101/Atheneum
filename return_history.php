                        ...
                        <table class="table table-hover table-striped" id="sample-table-1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center">Returned Date</th>
                                    <th class="center">Renewal Count</th>

                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $sql = $con->query("SELECT * from `book_issue` where status =2 and lib_id='" . $_SESSION['login'] . "';");
                                $count = 1;
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center"><?php echo $row['renewal_count']; ?></td>
