...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `atheneum`.`student_info`(`name`, `lib_id`, `usn`, `number`, `email`, `password`) VALUES ('$name','$lib_id','$usn','$number','$email','$password')";
    ...
    <div class="signup-form">
        <form method="post">
            ...
            <div class="form-group">
                <p style="color:red" class="star">*</p>
                <span class="input-icon">
                    <input type="text" class="form-control" name="lib_id" placeholder="Library-ID" required="required">
                    <i class="fa fa-user"></i> </span>
            </div>
